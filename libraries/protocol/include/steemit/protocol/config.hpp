...
#define STEEMIT_GENESIS_TIME                    (fc::time_point_sec(fc::time_point::now()))
...
#define STEEMIT_HARDFORK_REQUIRED_WITNESSES     5 // 17 of the 21 dpos witnesses (20 elected and 1 virtual time) required for hardfork. This guarantees 75% participation on all subsequent rounds.
